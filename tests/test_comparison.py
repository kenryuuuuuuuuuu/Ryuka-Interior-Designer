...
class ComparisonTests(unittest.TestCase):
    def setUp(self):
        ...
        self.report=dict(levelFileUnchanged=True,comparisonState=dict(variant='natural',
            azimuthDeg=180,elevationDeg=30,solar=self.case,camera={'lensMm':20},sunLux=50000,
            exposureEV100=7.5,roomId='room-1f-06'),width=1600,height=900,
    ...
    def test_finish_change_allowed_but_camera_and_exposure_locked(self):
        changed=copy.deepcopy(self.report); changed['comparisonState']['variant']='warm'
