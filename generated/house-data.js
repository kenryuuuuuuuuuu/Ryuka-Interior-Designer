...
const INTERIOR_DOORS = [
  { id:'door-001', type:'door-hinged', category:'door', operation:'swing', label:'トイレ⟷玄関', wallAt:0.91, orientation:'V', center:2.33, width:0.8, height:2, floor:1, hingeSide:'R', swingDir:'out', status:'verified' },
  { id:'door-002', type:'door-hinged', category:'door', operation:'swing', label:'玄関⟷洗面脱衣室', wallAt:2.73, orientation:'H', center:1.355, width:0.8, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-003', type:'door-hinged', category:'door', operation:'swing', label:'洗面脱衣室⟷UB', wallAt:4.55, orientation:'H', center:1.371, width:0.8, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-004', type:'door-hinged', category:'door', operation:'swing', label:'玄関⟷LDK張り出し', wallAt:2.73, orientation:'H', center:2.274, width:0.8, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-005', type:'door-hinged', category:'door', operation:'swing', label:'玄関⟷洋室', wallAt:2.73, orientation:'V', center:2.329, width:0.8, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-006', type:'door-hinged-wide', category:'door', operation:'swing', label:'ヌック⟷LDK', wallAt:2.73, orientation:'H', center:8.218, width:0.91, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-007', type:'door-hinged-wide', category:'door', operation:'swing', label:'自宅玄関・ホール⟷LDK', wallAt:2.73, orientation:'H', center:9.555, width:0.91, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-008', type:'door-hinged-wide', category:'door', operation:'swing', label:'自宅玄関・ホール⟷土間・シューズクローク', wallAt:10.92, orientation:'V', center:0.91, width:0.91, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-009', type:'door-hinged-wide', category:'door', operation:'swing', label:'土間・シューズクローク⟷LDK', wallAt:2.275, orientation:'H', center:13.195, width:0.91, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-010', type:'door-hinged-wide', category:'door', operation:'swing', label:'LDK(キッチン部)⟷廊下+収納', wallAt:15.471, orientation:'V', center:2.275, width:0.91, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-011', type:'door-hinged-wide', category:'door', operation:'swing', label:'ファミリークローク⟷廊下+収納', wallAt:1.82, orientation:'H', center:16, width:0.91, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-012', type:'door-hinged-wide', category:'door', operation:'swing', label:'トイレ(東)⟷洗面(東)', wallAt:2.73, orientation:'H', center:17.746, width:0.91, height:2, floor:1, hingeSide:'R', swingDir:'out', status:'verified' },
  { id:'door-013', type:'door-hinged-wide', category:'door', operation:'swing', label:'廊下+収納⟷脱衣室', wallAt:3.64, orientation:'H', center:16.836, width:0.91, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-014', type:'door-hinged-wide', category:'door', operation:'swing', label:'脱衣室⟷UB(東)', wallAt:17.291, orientation:'V', center:4.584, width:0.91, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-015', type:'door-hinged-wide', category:'door', operation:'swing', label:'脱衣室⟷南土間', wallAt:6.37, orientation:'H', center:16.836, width:0.91, height:2, floor:1, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-016', type:'door-hinged-wide', category:'door', operation:'swing', label:'トイレ(2F)⟷廊下(2F)', wallAt:1.82, orientation:'H', center:13.195, width:0.91, height:2, floor:2, hingeSide:'R', swingDir:'out', status:'verified' },
  { id:'door-017', type:'door-hinged-wide', category:'door', operation:'swing', label:'廊下(2F)⟷子供部屋1', wallAt:2.73, orientation:'H', center:15.015, width:0.91, height:2, floor:2, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-018', type:'door-hinged-wide', category:'door', operation:'swing', label:'廊下(2F)⟷子供部屋2', wallAt:16.38, orientation:'V', center:2.275, width:0.91, height:2, floor:2, hingeSide:'R', swingDir:'in', status:'verified' },
  { id:'door-019', type:'door-hinged-wide', category:'door', operation:'swing', label:'廊下(2F)⟷夫婦寝室', wallAt:2.73, orientation:'H', center:15.925, width:0.91, height:2, floor:2, hingeSide:'R', swingDir:'in', status:'verified' },
];
