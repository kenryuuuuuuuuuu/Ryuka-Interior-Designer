...
const ELECTRICAL_ITEMS = [
  ...
  { id:'elec-043', type:'outlet-double', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:1.92, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 1', status:'estimated' },
  { id:'elec-044', type:'outlet-double', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'V', center:2.83, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 2', status:'estimated' },
  ...
  { id:'elec-070', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:7.28, orientation:'V', center:3.79, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 2', status:'estimated' },
  { id:'elec-071', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:6.37, orientation:'H', center:1.92, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 3', status:'estimated' },
  { id:'elec-072', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:2.4, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 4', status:'estimated' },
  { id:'elec-073', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'V', center:3.32, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 5', status:'estimated' },
  ...
  { id:'elec-108', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:7.28, orientation:'V', center:4.28, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 1', status:'estimated' },
  { id:'elec-109', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:6.37, orientation:'H', center:2.4, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 2', status:'estimated' },
  { id:'elec-110', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:0.91, orientation:'H', center:2.83, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 1', status:'estimated' },
  ...
  { id:'elec-119', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:1.82, orientation:'V', center:4.64, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  ...
  { id:'elec-121', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:2.28, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  ...
  { id:'elec-143', type:'data-tv', category:'data', mount:'wall', level:1, wallAt:2.73, orientation:'V', center:3.21, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.3, heightRef:'floor', shape:'dataJack', label:'TV端子', status:'estimated' },
