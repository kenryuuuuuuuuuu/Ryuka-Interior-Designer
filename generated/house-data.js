...
const ELECTRICAL_ITEMS = [
  ...
  { id:'elec-008', type:'light-ceiling', category:'lighting', mount:'ceiling', level:1, x:3.18, z:4.55, width:0.35, depth:0.35, height:0.12, mountHeight:0, heightRef:'ceiling', shape:'ceilingLight', label:'シーリングライト', status:'estimated', room:'room-1f-06' },
  { id:'elec-009', type:'light-pendant', category:'lighting', mount:'ceiling', level:1, x:5.92, z:4.55, width:0.25, depth:0.25, height:0.2, mountHeight:0.6, heightRef:'ceiling', shape:'pendantLight', label:'ペンダントライト', status:'estimated', room:'room-1f-06' },
  ...
  { id:'elec-040', type:'outlet-double', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'V', center:1.01, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 1', status:'estimated' },
  ...
  { id:'elec-042', type:'outlet-double', category:'outlet', mount:'wall', level:1, wallAt:6.37, orientation:'V', center:2.42, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 3', status:'estimated' },
  { id:'elec-043', type:'outlet-double', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:0.1, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 1', status:'estimated' },
  { id:'elec-044', type:'outlet-double', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'V', center:1.01, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 2', status:'estimated' },
  { id:'elec-045', type:'outlet-double', category:'outlet', mount:'wall', level:1, wallAt:1.82, orientation:'V', center:2.83, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 3', status:'estimated' },
  ...
  { id:'elec-050', type:'outlet-double', category:'outlet', mount:'wall', level:1, wallAt:7.28, orientation:'V', center:1.01, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 3', status:'estimated' },
  { id:'elec-051', type:'outlet-double', category:'outlet', mount:'wall', level:1, wallAt:10.92, orientation:'V', center:0.55, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 4', status:'estimated' },
  ...
  { id:'elec-053', type:'outlet-double', category:'outlet', mount:'wall', level:1, wallAt:1.82, orientation:'H', center:13.75, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口）', status:'estimated' },
  ...
  { id:'elec-057', type:'outlet-double', category:'outlet', mount:'wall', level:2, wallAt:2.73, orientation:'H', center:12.84, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 2', status:'estimated' },
  { id:'elec-058', type:'outlet-double', category:'outlet', mount:'wall', level:2, wallAt:2.73, orientation:'H', center:12.84, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 1', status:'estimated' },
  ...
  { id:'elec-061', type:'outlet-double', category:'outlet', mount:'wall', level:2, wallAt:2.73, orientation:'H', center:12.84, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 2', status:'estimated' },
  { id:'elec-062', type:'outlet-double', category:'outlet', mount:'wall', level:2, wallAt:16.38, orientation:'V', center:0.1, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 3', status:'estimated' },
  { id:'elec-063', type:'outlet-double', category:'outlet', mount:'wall', level:2, wallAt:2.73, orientation:'H', center:12.84, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 1', status:'estimated' },
  { id:'elec-064', type:'outlet-double', category:'outlet', mount:'wall', level:2, wallAt:16.38, orientation:'V', center:0.1, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（2口） 2', status:'estimated' },
  { id:'elec-065', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:0.91, orientation:'V', center:1.01, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付）', status:'estimated' },
  { id:'elec-066', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:0.1, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付）', status:'estimated' },
  { id:'elec-067', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:4.55, orientation:'H', center:0.1, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付）', status:'estimated' },
  { id:'elec-068', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:3.69, orientation:'H', center:2.83, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付）', status:'estimated' },
  { id:'elec-069', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:3.69, orientation:'H', center:2.83, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 1', status:'estimated' },
  { id:'elec-070', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:7.28, orientation:'V', center:1.01, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 2', status:'estimated' },
  { id:'elec-071', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:6.37, orientation:'H', center:0.1, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 3', status:'estimated' },
  { id:'elec-072', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:0.59, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 4', status:'estimated' },
  { id:'elec-073', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'V', center:1.5, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 5', status:'estimated' },
  { id:'elec-074', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:13.65, orientation:'V', center:0.1, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 1', status:'estimated' },
  { id:'elec-075', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:15.47, orientation:'V', center:0.1, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 2', status:'estimated' },
  { id:'elec-076', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:6.37, orientation:'H', center:0.1, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付） 3', status:'estimated' },
  ...
  { id:'elec-080', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:16.48, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付）', status:'estimated' },
  { id:'elec-081', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:15.47, orientation:'V', center:0.1, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付）', status:'estimated' },
  { id:'elec-082', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:17.29, orientation:'V', center:1.92, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付）', status:'estimated' },
  ...
  { id:'elec-084', type:'outlet-grounded', category:'outlet', mount:'wall', level:1, wallAt:1.82, orientation:'H', center:13.75, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付）', status:'estimated' },
  ...
  { id:'elec-087', type:'outlet-grounded', category:'outlet', mount:'wall', level:2, wallAt:0, orientation:'H', center:12.84, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.25, heightRef:'floor', shape:'outletPlate', label:'コンセント（アース付）', status:'estimated' },
  ...
  { id:'elec-090', type:'outlet-ac', category:'outlet', mount:'wall', level:1, wallAt:7.28, orientation:'V', center:1.01, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:2, heightRef:'floor', shape:'outletPlate', label:'コンセント（AC専用）', status:'estimated' },
  { id:'elec-091', type:'outlet-ac', category:'outlet', mount:'wall', level:1, wallAt:1.82, orientation:'V', center:3.32, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:2, heightRef:'floor', shape:'outletPlate', label:'コンセント（AC専用）', status:'estimated' },
  ...
  { id:'elec-095', type:'outlet-ac', category:'outlet', mount:'wall', level:2, wallAt:6.37, orientation:'H', center:12.84, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:2, heightRef:'floor', shape:'outletPlate', label:'コンセント（AC専用）', status:'estimated' },
  { id:'elec-096', type:'outlet-ih', category:'outlet', mount:'wall', level:1, wallAt:3.69, orientation:'H', center:3.32, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.2, heightRef:'floor', shape:'outletPlate', label:'コンセント（IH専用）', status:'estimated' },
  ...
  { id:'elec-100', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:1.82, orientation:'H', center:13.75, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 1', status:'estimated' },
  { id:'elec-101', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:15.47, orientation:'V', center:0.1, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 2', status:'estimated' },
  ...
  { id:'elec-103', type:'switch-3way', category:'switch', mount:'wall', level:2, wallAt:16.38, orientation:'V', center:0.1, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 2', status:'estimated' },
  { id:'elec-104', type:'switch-3way', category:'switch', mount:'wall', level:2, wallAt:19.11, orientation:'V', center:0.1, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 1', status:'estimated' },
  ...
  { id:'elec-106', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:7.28, orientation:'V', center:1.5, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 1', status:'estimated' },
  { id:'elec-107', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:10.92, orientation:'V', center:1.04, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 2', status:'estimated' },
  { id:'elec-108', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:7.28, orientation:'V', center:1.5, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 1', status:'estimated' },
  { id:'elec-109', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:6.37, orientation:'H', center:0.59, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 2', status:'estimated' },
  { id:'elec-110', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:0.91, orientation:'H', center:0.1, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 1', status:'estimated' },
  { id:'elec-111', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:2.73, orientation:'V', center:1.5, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路） 2', status:'estimated' },
  { id:'elec-112', type:'switch-3way', category:'switch', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:7.38, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（3路）', status:'estimated' },
  ...
  { id:'elec-114', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:0.1, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  ...
  { id:'elec-116', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:0.91, orientation:'V', center:1.01, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  { id:'elec-117', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:4.55, orientation:'H', center:0.1, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切） 1', status:'estimated' },
  { id:'elec-118', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:1.82, orientation:'V', center:2.83, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切） 2', status:'estimated' },
  { id:'elec-119', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:1.82, orientation:'V', center:2.83, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  { id:'elec-120', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:16.48, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  { id:'elec-121', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:1.08, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  ...
  { id:'elec-124', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:2.28, orientation:'H', center:11.02, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  ...
  { id:'elec-128', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:0, orientation:'H', center:12.84, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切） 1', status:'estimated' },
  ...
  { id:'elec-131', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:1.82, orientation:'H', center:13.75, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  { id:'elec-132', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:2.73, orientation:'H', center:16.48, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  { id:'elec-133', type:'switch-1p', category:'switch', mount:'wall', level:1, wallAt:17.29, orientation:'V', center:1.92, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切） 1', status:'estimated' },
  ...
  { id:'elec-139', type:'switch-1p', category:'switch', mount:'wall', level:2, wallAt:1.82, orientation:'H', center:12.84, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  { id:'elec-140', type:'switch-1p', category:'switch', mount:'wall', level:2, wallAt:2.73, orientation:'H', center:13.33, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  { id:'elec-141', type:'switch-1p', category:'switch', mount:'wall', level:2, wallAt:1.82, orientation:'H', center:12.84, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  { id:'elec-142', type:'switch-1p', category:'switch', mount:'wall', level:2, wallAt:19.11, orientation:'V', center:0.1, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:1.2, heightRef:'floor', shape:'switchPlate', label:'スイッチ（片切）', status:'estimated' },
  { id:'elec-143', type:'data-tv', category:'data', mount:'wall', level:1, wallAt:2.73, orientation:'V', center:1.99, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.3, heightRef:'floor', shape:'dataJack', label:'TV端子', status:'estimated' },
  { id:'elec-144', type:'data-tv', category:'data', mount:'wall', level:1, wallAt:13.65, orientation:'V', center:0.59, side:-1, width:0.09, depth:0.02, height:0.09, mountHeight:0.3, heightRef:'floor', shape:'dataJack', label:'TV端子', status:'estimated' },
  { id:'elec-145', type:'data-tv', category:'data', mount:'wall', level:2, wallAt:2.73, orientation:'H', center:13.33, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.3, heightRef:'floor', shape:'dataJack', label:'TV端子', status:'estimated' },
  { id:'elec-146', type:'data-tv', category:'data', mount:'wall', level:2, wallAt:12.74, orientation:'V', center:0.1, side:1, width:0.09, depth:0.02, height:0.09, mountHeight:0.3, heightRef:'floor', shape:'dataJack', label:'TV端子', status:'estimated' },
  { id:'elec-147', type:'data-intercom', category:'data', mount:'wall', level:1, wallAt:1.82, orientation:'H', center:1.01, side:-1, width:0.09, depth:0.03, height:0.15, mountHeight:1.4, heightRef:'floor', shape:'intercomPanel', label:'インターホン', status:'estimated' },
  ...
  { id:'elec-150', type:'light-exterior', category:'lighting', mount:'exterior', level:1, face:'N', offset:2, width:0.12, depth:0.1, height:0.15, mountHeight:1.8, heightRef:'floor', shape:'bracketLight', label:'外灯（壁付けブラケット） 1', status:'estimated' }, // 民泊棟 玄関脇
  { id:'elec-151', type:'light-exterior', category:'lighting', mount:'exterior', level:1, face:'N', offset:11.5, width:0.12, depth:0.1, height:0.15, mountHeight:1.8, heightRef:'floor', shape:'bracketLight', label:'外灯（壁付けブラケット） 2', status:'estimated' }, // 自宅 玄関脇
