...
Blender＋Unrealで進める内装・採光検討の方針と再生成手順は [docs/VISUAL_TWIN_PLAN.md](docs/VISUAL_TWIN_PLAN.md) を参照してください。ゲストハウスLDKのBlender比較画像とUnreal Engine 5.8.2への検証付き取り込みを実装しています。仮仕上げ・手動太陽角度による試作で、実所在地・日時の採光評価とUnrealの専用内覧UIは未完了です。
