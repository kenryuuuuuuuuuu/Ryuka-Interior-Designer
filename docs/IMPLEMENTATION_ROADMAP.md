...
2026-09-09更新。W05-v2（fcc99c2）まで受入済みです（採光は仮条件での機能確認）。**残りはW06〜W08の3段階**です。W06は詳細仕様READY、W07以降は事前計画（DRAFT）です。前段階の受入時に見直します。本書は古いVISUAL_TWIN_PLAN/STATUS内の進行順より優先します。
...
| 実装待ちREADY | [W06 電気設備・照明](tasks/W06-electrical-lighting.md) | 器具配置を反映し、夜の点灯案を比較する | 大 |
